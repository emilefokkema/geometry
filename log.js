(function(){
	var makeLog = function(canvas, planeMath, copySet, floatPattern, distinctArray){
		var allCalls = [];
	...
	window.initGeometry = (function(orig){
		return function(obj){
			orig(obj);
			obj.log = makeLog(obj.canvas, obj.planeMath, obj.copySet, obj.floatPattern, obj.distinctArray);
		};
